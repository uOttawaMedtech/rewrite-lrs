    ...
    LRSRewriter.prototype = {
        ...
        */
        ...
        prepareSaveStateEntryTask: function(key, value, cfg, replace_with) {
            ...
            var description = "Saving new state entry '" + key + "' for activity " + newcfg.activity.id
            if (newcfg.registration) {
                description += " with registration " + newcfg.registration
            }
