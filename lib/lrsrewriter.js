    ...
    LRSRewriter.prototype = {
        ...
        */
        ...
        initReplaceAgent: function(oldAgent, newAgent, doneInitReplaceAgent) {
            ...
            _this.Task.create(_this.prepareQueryStatementsTask(cfg), function(err, results) {
                if (err) {
        ...
        treatCallResponse: function (call, err, response, callback) {
            ...
            switch(call.method) {
                ...
                case 'retrieveStateEntries':
                    ...
                    break;
                case 'retrieveState':
                    console.log(call.params[0] + ": " + response.contents)
                    break;
            }
        ...
        prepareSaveStateEntryTask: function(key, value, activity, agent) {

        },

        prepareDropStateEntryTask: function(key, activity, agent) {
