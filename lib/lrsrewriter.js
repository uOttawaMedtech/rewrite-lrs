        ...
        */
        ...
        startTasks: function (callback) {
            ...
            _this.timer = setInterval(function(){
                if (_this.numTasksQueued && _this.numTasksQueued <= _this.numTasksAttempted) {
                    callback(null, _this.numTasksAttempted)
                    _this.numTasksQueued = _this.numTasksAttempted = 0
        ...
        attemptTasks: function (callback) {
            var _this = this
            if (!_this.numTasksQueued) {
                // fetch tasks and execute the ones of type
