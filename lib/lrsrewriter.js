    ...
    */
    ...
    LRSRewriter.prototype = {
        ...
        */
        ...
        replaceAgent: function(old_agent, new_agent, callback) {
            var query_for = {
                agent: old_agent
            }
            var replace_with = {
            ...
            this.addJob(query_for, replace_with, callback)
        },
                ...
                if (!exists) {
                    _this.Job.create({ params: params }, function(err, newjob) {
                        if (err) {
                            ...
                            queryStatementsTask.job_id = newjob.id
        ...
        treatCallResponse: function (task, err, response, callback) {
            ...
            switch(call.method) {
                ...
                case 'saveStatement':
                    if (response) {
                        console.log(call.method + " => " + response.status);
                    }
                    break
            }
        ...
        prepareReissueStatementTask: function(statement, replace_with) {
            ...
            newstatement.actor = new TinCan.Agent(replace_with.agent);
            delete newstatement.id
        ...
        prepareSaveStateEntryTask: function(key, value, cfg, replace_with) {
            ...
            newcfg.agent = new TinCan.Agent(replace_with.agent)
